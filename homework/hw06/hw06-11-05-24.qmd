...
$$
\begin{cases}
1 \cdot v_1 - 1 \cdot v_2 = 0 \\ 3 \cdot v_1 - 3 \cdot v_2 = 0
\end{cases}
$$
...
Using Table 3.1, if the eigenvalues are of the form $\lambda = a \pm bi$ with $a = 0$ (purely imaginary),
then the origin is classified as **stable** and is called a **center**. This classification indicates that
the origin exhibits **neutral stability**, where solutions oscillate around the origin in a closed, non-decaying pattern.
