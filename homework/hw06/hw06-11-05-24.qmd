...
- **Saddle Point Behavior:**
  ...
  - Trajectories not on the eigenvector lines curve in the phase plane.
  - They approach the origin along the stable eigenvector direction when traced backward in time.
  - They move away from the origin along the unstable eigenvector direction as $t \to \infty$.

**Sketch Description:**

- **Quadrants:**

  - In quadrants where $x_1$ and $x_2$ have the same sign, trajectories move away from the origin along the line $x_2 = x_1$.
  - In quadrants where $x_1$ and $x_2$ have opposite signs, trajectories curve towards the stable line $x_2 = 3 x_1$ when traced backward.

- **Trajectory Shape:**

  - Trajectories resemble hyperbolas due to the saddle point nature.
  - They are symmetric with respect to the eigenvector lines.
