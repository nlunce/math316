...
The Laplace Transform has several useful properties that make it ideal for solving differential equations:
...
3. **Integration**:
   ...
   $$
   \mathcal{L}\left\{\int_0^t f(\tau) \, d\tau\right\} = \frac{\mathcal{L}\{f(t)\}}{s}.
   $$

4. **Time Shifting**:

   $$
   \mathcal{L}\{f(t - t_0) u(t - t_0)\} = e^{-st_0} \mathcal{L}\{f(t)\},
   $$
